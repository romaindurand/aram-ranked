...
class EmptyServerError extends Error {
  constructor () {
    super()
    this.message = 'A server is required'
    this.status = 'server_required'
  }
}

module.exports = {AuthTokenNotFoundError, EmptyUsernameError, UserNotFoundError, TotalUsersNotFoundError, EmptyServerError}
